...
import top.evolutionary.excel.util.date.Ihr360ExcelDateFormatUtil;
...
public class ExcelDefaultConfig {
    ...
    //日期类型默认输出格式
    public static final String DEFAULT_OUTPUT_DATE_PATTERN = Ihr360ExcelDateFormatUtil.PATTERN_DEFAULT_ON_SECOND;
