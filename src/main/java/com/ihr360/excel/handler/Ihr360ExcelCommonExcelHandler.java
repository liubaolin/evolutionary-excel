...
public class Ihr360ExcelCommonExcelHandler {
    ...
    public static Map<Integer, String> handleExportHeader(Workbook workbook, Row row, Map<String, Font> fontMap, ExportParams exportParams, int startIndex, Sheet sheet, final Map<Integer, Class> dateTypeIndexMap) {
        ...
        for (int i = 0; i < headerKeys.size(); i++) {
            ...
            Ihr360ExcelCellCommentHandler.setHeaderComment(sheet, headerCommentMap, cell, headerKey);

            CellStyle poiCellStyle = Ihr360ExcelCellStyleHandler.getPoiCellStyle(workbook, fontMap, defaultHeaderCellStyle, excelCellStyleMap, headerStyleMap, headerKey);
