...
import com.ihr360.excel.metaData.MergedExportData;
...
import static com.ihr360.excel.handler.Ihr360ExcelCellStyleHandler.getPoiCellStyle;
import static com.ihr360.excel.handler.Ihr360ExcelCellStyleHandler.setSheetAutoAddWidthColumn;
 ...
 * @author richey
 */
public class Ihr360ExcelSheetHandler {

    private static Logger logger = LoggerFactory.getLogger(Ihr360ExcelSheetHandler.class);
    ...
    public static <T> void write2Sheet() {
        ...
        //设置隐藏列
        Ihr360ExcelColumnHandler.setColumnHidden();
        ...
        if (CollectionUtils.isNotEmpty(headerMergedReginSpcifications)) {
            ...
            for (MergedRegionSpecification specification : headerMergedReginSpcifications) {
                ...
                datePatternIndexMap = Ihr360ExcelCommonExcelHandler.handleExportHeader(workbook,
            ...
            row.setHeightInPoints(ExcelDefaultConfig.DEFAULT_ROW_HEADER_HEIGHT_INPOINT);
            datePatternIndexMap = Ihr360ExcelCommonExcelHandler.handleExportHeader(workbook, row, fontMap, exportParams, 0, sheet, dateTypeIndexMap);
        }
        ...
        if (CollectionUtils.isNotEmpty(dataMergedReginSpcifications)) {
            ...
            dataMergedReginSpcifications.forEach(dataMergedReginSpcification -> {
                ...
                for (int i = 0; i < headerKeys.size(); i++) {
                    ...
                    Ihr360ExcelCellHandler.setCellValue(cell, dataMap.get(headerKeys.get(i)), ExcelDefaultConfig.DEFAULT_OUTPUT_DATE_PATTERN, null, textCellStyle, null);
                }
            });
        ...
        if (CollectionUtils.isEmpty(datas)) {
            ...
            Ihr360ExcelDropListHandler.handleDropDownList(exportParams, workbook, sheet, 1, 1000);
            for (int i = 0; i < headers.size(); i++) {
                setSheetAutoAddWidthColumn(sheet, i);
                sheet.setDefaultColumnStyle(i, textCellStyle);
            }
        ...
        Ihr360ExcelDropListHandler.handleDropDownList(exportParams, workbook, sheet, 1, datas.size() + 10);
            ...
            try {
                if (rowData instanceof List) {
                    ...
                    for (int i = 0; i < cellDatas.size(); i++) {
                        ...
                        Ihr360ExcelCellHandler.setCellValue(cell, cellDatas.get(i), datePattern, null, textCellStyle, clazz);
                    }
                    ...
                    for (int i = 0; i < headerKeys.size(); i++) {
                        ...
                        Ihr360ExcelCellHandler.setCellValue(cell, cellMap.get(headerKeys.get(i)), datePattern, null, textCellStyle, null);
                    }

                } else {
                    List<Field> fields = Ihr360ExcelJavaBeanDataHandler.getExcelCellField(rowData.getClass());
                    ...
                    for (int i = 0; i < headerKeys.size(); i++) {
                        ...
                        Ihr360ExcelCellHandler.setCellValue(cell, value, datePattern, field, textCellStyle, null);
                    }
                }
            } catch (Exception e) {
