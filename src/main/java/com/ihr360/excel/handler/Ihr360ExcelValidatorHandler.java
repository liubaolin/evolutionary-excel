...
import com.ihr360.excel.metaData.CellTypeMode;
...
public class Ihr360ExcelValidatorHandler {
    ...
    public static boolean cellNullValid(Cell cell, boolean allowNull) {
        return !Ihr360ExcelCellHandler.isNullOrBlankStringCell(cell) || (Ihr360ExcelCellHandler.isNullOrBlankStringCell(cell) && allowNull);
    }
