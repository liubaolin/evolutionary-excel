 ...
 * @author richey
 */
public class Ihr360DefaultAbstractExcelConfiguration extends AbstractExcelConfigurerAdapter {

    private Ihr360DefaultAbstractExcelConfiguration() {
        super();
    }

    public static Ihr360DefaultAbstractExcelConfiguration.Builder builder() {
        return new Ihr360DefaultAbstractExcelConfiguration.Builder();
    }
    ...
    public static class Builder {
        ...
        public Ihr360DefaultAbstractExcelConfiguration build() {
            Ihr360DefaultAbstractExcelConfiguration ihr360DefaultExcelConfiguration = new Ihr360DefaultAbstractExcelConfiguration();
